...
function ProjectWorkbench() {
  ...
  const nextStep = (() => {
    ...
    if (isFinished) return { title: '下载 PPTX', desc: '文件已保存至云端存档；本地缓存保留 5 天，之后仍可从存档下载。' }
